  ...
  return (
    ...
    <div className="flex flex-col w-20 h-full ">
      ...
      <div className="w-20 h-fit order-0">
        <button
          className={
            "w-20 h-20 pt-6 text-xs bg-menuIcone text-Platinum text-center bg-auto bg-origin-padding bg-[center_top_0.7rem] bg-no-repeat hover:bg-Platinum/20 focus:bg-Platinum/10 mx-auto" +
      ...
      <div className="w-20 h-fit order-3">
        <button
          className={
            "w-20 h-20 pt-6 text-xs bg-addContactIcone text-Platinum text-center bg-auto bg-origin-padding bg-[center_top_0.7rem] bg-no-repeat hover:bg-Platinum/20 focus:bg-Platinum/10 mx-auto" +
            (prop.chatListShow ? " max-lg:w-16  " : " max-lg:hidden")
          }
          onClick={() => {
            prop.setCustomizeTabVisibility({
